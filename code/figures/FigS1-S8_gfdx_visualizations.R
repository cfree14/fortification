...
ggsave(g, filename=file.path(plotdir, "FigS6_gfdx_data_years.png"), 
...
ggsave(g, filename=file.path(plotdir, "FigS1_gfdx_data.png"), 
       width=6.5, height=3.8, units="in", dpi=600)
...
# Export
ggsave(g1, filename=file.path(plotdir, "FigS3_gfdx_nutr_stds_vitamins.png"), 
...
# Export
ggsave(g2, filename=file.path(plotdir, "FigS4_gfdx_nutr_stds_minerals.png"), 
...
# Export
ggsave(g, filename=file.path(plotdir, "FigS2_gfdx_intake_prop_dists.png"), 
...
# Export figure
ggsave(g, filename=file.path(plotdir, "FigS5_gfdx_fort_standards_boxplots.png"), 
       width=6.5, height=4.5, units="in", dpi=600)
...
# Export
ggsave(g, filename=file.path(plotdir, "FigS7_gfdx_availability_processed_prop.png"), 
...
# Export
ggsave(g, filename=file.path(plotdir, "FigS8_gfdx_availability_fortified_prop.png"), 
       width=6.5, height=7.5, units="in", dpi=600)
