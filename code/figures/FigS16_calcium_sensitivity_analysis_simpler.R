...
layout_matrix <- matrix(data=c(1,1,
                               2,2), byrow=1, ncol=2)
g <- gridExtra::grid.arrange(g1, g3, layout_matrix=layout_matrix, heights=c(0.2, 0.8))

# Export
ggsave(g, filename=file.path(plotdir, "FigS16_calcium_sensitivity_analysis_simpler.png"), 
